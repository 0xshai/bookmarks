...
export const bookmarks: Category[] = [
    ...
    items: [
      {
        ...
        desc: "Markdown 风格图表语言，支持流程图、时序图、甘特图",
        opensource: true,
      },
      {
        name: "D2",
        url: "https://d2lang.com",
        desc: "现代图表脚本语言，自动布局，生成效果优秀",
        opensource: true,
      },
      {
        name: "draw.io",
        url: "https://app.diagrams.net",
        desc: "免费在线流程图与图表绘制工具，支持本地保存，可与 Google Drive/GitHub 集成",
        opensource: true,
      },
      {
        name: "Drawnix",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "极简界面的 Firefox 内核浏览器",
        opensource: true,
      },
      {
        name: "Mullvad Browser",
        url: "https://mullvad.net/browser",
        desc: "由 Mullvad VPN 与 Tor 项目联合开发",
        opensource: true,
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "MotrixNext",
        url: "https://motrix-next.pages.dev/#",
        desc: "全能下载管理器",
        opensource: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "专业录屏与直播推流工具，跨平台开源",
        opensource: true,
      },
      {
        name: "HandBrake",
        url: "https://handbrake.fr",
        desc: "开源视频转码压制工具，支持 AV1/H.265/H.264，跨平台免费",
        opensource: true,
      },
      {
        name: "MediaInfo",
    ...
    items: [
      {
        name: "mpv",
        url: "https://mpv.io",
        desc: "轻量高性能的命令行视频播放器，支持脚本扩展，GPU 解码，几乎兼容所有格式",
        opensource: true,
      },
      {
        name: "Screenbox",
        url: "https://github.com/huynhsontung/Screenbox",
        desc: "基于 libVLC 的现代 Windows 视频播放器，界面简洁流畅，支持网络串流",
        opensource: true,
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "轻量 GPU 加速 RAW 编辑器，界面简洁现代",
        opensource: true,
      },
      {
        name: "remove.photos",
        url: "https://remove.photos/zh-cn/",
        desc: "在线 AI 抠图，无需注册，免费下载高清透明图",
      },
      {
        name: "Squoosh",
        url: "https://squoosh.app",
        desc: "Google 出品的在线图片压缩工具，实时对比画质与体积，本地处理不上传",
        opensource: true,
      },
      {
        name: "ImageMagick",
        url: "https://imagemagick.org",
        desc: "命令行图片处理工具，批量转换格式、调整尺寸、压缩质量，功能全面",
        opensource: true,
      },
      {
        name: "PicView",
        url: "https://picview.org",
        desc: "快速、轻量的开源看图工具，支持 RAW、AVIF、HEIC 等格式，可直接删除元数据",
        opensource: true,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "硬盘健康状态与 S.M.A.R.T. 监控工具",
        opensource: true,
      },
      {
        name: "ShareX",
        url: "https://getsharex.com",
        desc: "功能最强的开源截图录屏工具，支持几十种上传目标与工作流自动化",
        opensource: true,
      },
      {
        name: "BleachBit",
        url: "https://www.bleachbit.org",
        desc: "开源系统清理工具，清除缓存、日志、浏览器数据，支持文件粉碎",
        opensource: true,
      },
      {
        name: "Bulk Crap Uninstaller",
        url: "https://www.bcuninstaller.com",
        desc: "批量卸载 Windows 程序，自动清理残留，速度远超系统自带卸载",
        opensource: true,
      },
      {
        name: "System Informer",
        url: "https://systeminformer.io",
        desc: "Process Hacker 继任者，进程、服务、网络连接监控与分析",
        opensource: true,
      },
      {
        name: "NanaZip",
        url: "https://github.com/M2Team/NanaZip",
        desc: "7-Zip 的现代化 Fork，原生适配 Windows 11 右键菜单",
        opensource: true,
      },
      {
        name: "Rufus",
        url: "https://rufus.ie",
        desc: "最快的 USB 启动盘制作工具，支持 ISO 写入与 Windows To Go",
        opensource: true,
      },
      {
        name: "RustDesk",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Docker/Kubernetes 容器可视化管理面板，图形界面操作镜像、网络、容器，社区版免费",
        opensource: true,
      },
      {
        name: "Homepage",
        url: "https://gethomepage.dev",
        desc: "高度可定制的自托管服务起始页，聚合所有自部署服务入口，支持状态监控与小组件",
        opensource: true,
      },
      {
        name: "n8n",
        url: "https://n8n.io",
        desc: "开源工作流自动化平台，可视化拖拽连接各种 API 与服务，自托管后数据完全自主可控",
        opensource: true,
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        name: "Umami",
        url: "https://umami.is",
        desc: "开源隐私友好的网站统计，无 Cookie、不收集个人信息，可自托管，Google Analytics 替代",
        opensource: true,
      },
      {
        name: "Google Search Console",
        url: "https://search.google.com/search-console",
        desc: "监控网站在 Google 搜索中的收录与关键词表现，可手动提交新页面加速索引",
      },
      {
        name: "itdog",
        url: "https://www.itdog.cn",
        desc: "国内多节点网络测速，支持 ping、tcping、HTTP 测速、路由追踪，覆盖各省各运营商",
      },
      {
        name: "WebPageTest",
        url: "https://www.webpagetest.org",
        desc: "全球节点网页性能分析，瀑布图、Core Web Vitals、首屏渲染等指标一览",
        opensource: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "运营三十年的免费二级域名，稳定可靠，审核较慢但值得等",
      },
      {
        name: "is-a.dev",
        url: "https://is-a.dev",
        desc: "专为开发者提供的免费 .is-a.dev 子域名，GitHub PR 审核，流程透明",
        opensource: true,
      },
      {
        name: "DNSHE",
        url: "https://dnshe.com",
        desc: "免费子域名注册服务，支持 Cloudflare 托管，需每 180 天手动续期",
      },
      {
        name: "FreeDNS",
        url: "https://freedns.afraid.org",
        desc: "老牌免费 DNS 与子域名服务，运营二十余年，提供大量共享域名后缀",
      },
      {
        name: "deSEC",
        url: "https://desec.io",
    ...
    items: [
      {
        ...
        desc: "设备间直接同步，不经过任何服务器",
        opensource: true,
      },
      {
        name: "LocalSend",
        url: "https://localsend.org",
        desc: "局域网内跨设备传文件，无需联网",
        opensource: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "全平台开源办公套件，兼容 Office 格式",
        opensource: true,
      },
      {
        name: "Stirling-PDF",
        url: "https://www.stirlingpdf.com",
        desc: "自托管 PDF 工具集，合并、分割、压缩、转换、OCR 全套操作，文件不离开自己服务器",
        opensource: true,
      },
      {
        name: "Reactive Resume",
        url: "https://rxresu.me",
        desc: "开源简历生成器，多模板实时预览，数据完全自托管，无需把个人信息交给商业平台",
        opensource: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "Android 上最好的开源 2FA 应用",
        opensource: true,
      },
      {
        name: "2FAS",
        url: "https://2fas.com",
        desc: "跨平台 2FA，支持浏览器扩展",
        opensource: true,
      },
      {
        name: "Ente Auth",
        url: "https://ente.io/auth",
        desc: "端对端加密的跨平台 2FA，支持云备份",
        opensource: true,
      },
    ],
  },
    ...
    items: [
      {
        name: "Ente",
        url: "https://ente.io",
        desc: "端对端加密的照片与视频存储服务",
        opensource: true,
      },
      {
        name: "Ente Locker",
        url: "https://ente.com/locker",
        desc: "端对端加密的文档保险箱，支持紧急联系人移交",
        opensource: true,
      },
      {
        name: "Filen",
        url: "https://filen.io",
        desc: "德国端对端加密云盘，可同步任意文件",
        opensource: true,
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        name: "沙拉翻译",
        url: "https://saladict.net/",
        desc: "浏览器划词翻译，可同步至欧路词典",
        opensource: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "以打字输入为核心的英语记忆系统，FSRS 间隔复习，数据本地存储",
        opensource: true,
      },
      {
        name: "Exercism",
    ...
    items: [
      {
        ...
        desc: "本地优先的任务管理与时间追踪，支持 Jira/GitHub/GitLab 集成",
        opensource: true,
      },
      {
        name: "ActivityWatch",
        url: "https://activitywatch.net",
        desc: "自动记录应用与网页使用时间，数据完全本地，开源无云",
        opensource: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "本地 LLM 运行时，一条命令拉模型，提供 OpenAI 兼容 API",
        opensource: true,
      },
      {
        name: "Jan",
        url: "https://jan.ai",
        desc: "本地优先的 AI 客户端，内置聊天界面，可作为 Ollama 前端",
        opensource: true,
      },
      {
        name: "Ensu",
        url: "https://ente.com/blog/ensu",
        desc: "本地运行的 AI 聊天，模型不联网，对话不离开设备",
        opensource: true,
      },
      {
        name: "Voicebox",
        url: "https://voicebox.sh",
        desc: "开源本地 AI 语音工作室，声音克隆、全局听写、TTS 生成一体，数据不离本机，支持 MCP 接入 Claude",
        opensource: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "Claude Design 的开源平替，本地优先，支持接入 Coding Agent 生成 UI 原型",
        opensource: true,
      },
      {
        name: "Agency-Agents",
        url: "https://github.com/msitarzewski/agency-agents",
        desc: "200+ 专业 AI Agent 角色集合，覆盖工程、设计、营销等领域，兼容 Ollama 本地模型",
        opensource: true,
      },
      {
        name: "OpenCode",
        url: "https://opencode.ai/",
        desc: "开源 AI Coding Agent，支持终端/桌面/IDE，可接入 Claude、GPT、本地模型等 75+ 提供商",
        opensource: true,
      },
      {
        name: "OpenRouter",
        url: "https://openrouter.ai/",
        desc: "统一 API 接入 100+ 主流 AI 模型，支持 BYOK，方便在各 Coding 工具间切换模型源",
        opensource: false,
      },
      {
        name: "GitHub Models",
