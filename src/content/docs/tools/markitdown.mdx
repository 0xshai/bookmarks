---
title: MarkItDown 使用说明
description: 微软开源文档转 Markdown 工具 MarkItDown 的完整使用指南
---
...
<Aside type="tip">用 `python -m markitdown` 而不是直接 `markitdown`——不依赖 PATH，不依赖 venv 是否激活，Windows 上最稳妥的写法。路径含中文或空格时务必加引号。</Aside>
...
<Aside type="caution">这些均为社区第三方项目，非微软官方出品。</Aside>
